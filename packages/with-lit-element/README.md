# TLDR
1. Run `yarn start` and navigate to `http://127.0.0.1:8081/` for development environment.
1. In dev env, it doesn't support CSJ, everything is based on browser's ES6 module.
1. Run `yarn build` to build the distribution files.
